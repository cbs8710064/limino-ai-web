...
<template>
    <div class="h-100vh w-100% flex items-center justify-center justify-center">
        <div>
            <div class="flex justify-center">
                <TheButton type="border" @click="handleBackHome">{{ t('common.backHome') }}</TheButton>
            </div>
            <div class="w-200 container">
                <div class="row">
