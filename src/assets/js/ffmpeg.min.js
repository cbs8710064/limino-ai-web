!(function (e, t) {
  ...
  (() => {
    ...
    class i {
        ...
        this.#e ||
          ((this.#e = s
            ? new Worker(
                new URL(
                  s,
                  'file:///D:/Job/GithubOpenSources/ffmpeg.wasm-0.12.10/ffmpeg.wasm-0.12.10/packages/ffmpeg/dist/esm/classes.js'
                ),
                { type: 'module' }
              )
      ...
      rename = (e, s, { signal: r } = {}) =>
        this.#i({ type: t.RENAME, data: { oldPath: e, newPath: s } }, void 0, r)
