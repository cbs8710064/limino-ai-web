!(function (e, t) {
  ...
  (() => {
    ...
    var e = {
        ...
        431: (e, t) => {
          Object.defineProperty(t, '__esModule', { value: !0 }),
            (t.ERROR_INCOMPLETED_DOWNLOAD = t.ERROR_RESPONSE_BODY_READER = void 0),
            (t.ERROR_RESPONSE_BODY_READER = new Error('failed to get response body reader')),
            (t.ERROR_INCOMPLETED_DOWNLOAD = new Error('failed to complete download'))
        },
        915: function (e, t, o) {
          var r =
            (this && this.__awaiter) ||
                      ...
                      t(
                        Error(
                          `File could not be read! Code=${
                            (null ===
                              (r =
                                null === (o = null == e ? void 0 : e.target) || void 0 === o
                                  ? void 0
                                  : o.error) || void 0 === r
                              ? void 0
                              : r.code) || -1
              ...
              r(void 0, void 0, void 0, function* () {
                ...
                try {
                  ...
                  console.log('failed to send download progress event: ', o),
                    ...
                    t &&
                      t({ url: e, total: d.byteLength, received: d.byteLength, delta: 0, done: !0 })
                }
                return d
              })),
